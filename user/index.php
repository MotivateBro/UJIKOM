  ...
  <header>
    <div class="container px-4 px-lg-5 my-5">
      <div class="text-center text-white">
        <h1 class="display-4 fw-bolder">Welcome To Gallery Photo, <?php echo $_SESSION['username'] ?></h1>
        <p class="lead fw-normal text-white-50 mb-0">Random Album And Photo With High Standard Picture</p>
      </div>
    </div>
  </header>
